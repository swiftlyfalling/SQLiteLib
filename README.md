...
**Dec 10, 2021: Update SQLite to 3.37.0** ([changelog](https://github.com/swiftlyfalling/SQLiteLib/commits/master)).

**Requirements**: iOS 8.0+ / OSX 10.9+, Xcode 7.3+

**SQLite Included:** **[3.37.0](https://www.sqlite.org/releaselog/3_37_0.html)**
